...
class Order(db.Model):
    ...
    order_status = Column(
        Enum("CHỜ XÁC NHẬN", "ĐÃ ĐẶT CỌC", "ĐÃ XÁC NHẬN", "ĐANG XỬ LÝ", "HOÀN THÀNH", "ĐÃ HỦY"),
        nullable=False,
...
class OrderItem(db.Model):
    ...
    item_status = Column(
        Enum("ĐANG XỬ LÝ", "HOÀN THÀNH", "ĐÃ HỦY"), nullable=False, default="ĐANG XỬ LÝ"
    )
    ...
    shipping_status = Column(
        Enum("ĐANG LẤY HÀNG", "ĐANG GIAO HÀNG", "ĐÃ GIAO"), nullable=True
    )
